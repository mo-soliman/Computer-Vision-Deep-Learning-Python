...
To fire this program just type the first command in the Commands.txt file after cd-ing
...
To fire this program just type the second command in the Commands.txt file after cd-ing
into the project directory.
